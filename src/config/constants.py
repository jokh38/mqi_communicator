...
# Fixed progress values for workflow phases
# These represent the progress percentage at the start of each phase
PROGRESS_CSV_INTERPRETING = 10.0
PROGRESS_UPLOADING = 20.0
PROGRESS_HPC_QUEUED = 30.0
PROGRESS_HPC_RUNNING = 40.0
PROGRESS_DOWNLOADING = 60.0
PROGRESS_POSTPROCESSING = 80.0
PROGRESS_COMPLETED = 100.0

# Phase names used in configuration and logging
PHASE_CSV_INTERPRETING = "CSV_INTERPRETING"
PHASE_UPLOADING = "UPLOADING"
PHASE_HPC_QUEUED = "HPC_QUEUED"
